            ...
            <div class="rd-navbar-main-outer">
              ...
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                  ...
                  <li class="active"><a href="typography.php">registrate<span></span><span></span><span></span><span></span></a>
                  </li>
          ...
          <div class="range range-30">
            <div class="cell-sm-6 cell-md-4 wow fadeInLeftSmall">
              ...
              <article class="post-boxed">
                ...
                <div class="post-boxed__main1">
                  <img src="images/r1.png">
                  <div class="form-wrap form-button offset-1">
                    <p>Elige esta opción si eres un estudiante de un politécnico o si eres un egresado y estás buscando una oportunidad de empleo.</p>
                    <a href="registroEstudianteEgresado.php" class="button"> Estudiante o egresado</a>
                  </div>
                </div>
            ...
            <div class="cell-sm-6 cell-md-4 wow fadeInLeftSmall" data-wow-delay=".15s">
              ...
              <article class="post-boxed">
                ...
                <div class="post-boxed__main1">
                  ...
                  <div class="form-wrap form-button offset-1">
                    <p>Elige esta opción si eres representante de una empresa y estas interesado en colocar empleos o pasantías para los estudiante o egresados de politécnicos. </p>
                    <a href="registroEmpresa.php" class="button"> Registrar empresa</a>
                  </div>
                </div>
            ...
            <div class="cell-sm-6 cell-md-4 wow fadeInLeftSmall" data-wow-delay=".15s">
              ...
              <article class="post-boxed">
                ...
                <div class="post-boxed__main1">
                  ...
                  <div class="form-wrap form-button offset-1">
                    <p>Elige esta opción si eres un coordinador de carrera o docente técnico y estás interesado en planificar y dar seguimiento a la formación en centro de trabajo.</p>
                    <a href="vacante.php" class="button"> Vacante</a>
                  </div>
                </div>
